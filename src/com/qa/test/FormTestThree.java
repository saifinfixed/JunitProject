...
public class FormTestThree extends QaBaseClass {
	@Test
	public void formTesThree(){
		...
		//Phone number
		driver.findElement(By.id("element_2_1")).sendKeys("");
		driver.findElement(By.id("element_2_2")).sendKeys("");
		driver.findElement(By.id("element_2_3")).sendKeys("");
